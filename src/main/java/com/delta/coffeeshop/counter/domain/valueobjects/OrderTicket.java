...
public class OrderTicket {
    ...
    public boolean equals(Object o) {
        ...
        if (orderId != null ? !orderId.equals(orderTicket.orderId) : orderTicket.orderId != null)
            return false;
        if (lineItemId != null ? !lineItemId.equals(orderTicket.lineItemId)
                : orderTicket.lineItemId != null)
            return false;
        if (item != orderTicket.item)
            return false;
        if (name != null ? !name.equals(orderTicket.name) : orderTicket.name != null)
            return false;
        return timestamp != null ? timestamp.equals(orderTicket.timestamp)
                : orderTicket.timestamp == null;
    }
    ...
    public String toString() {
        return "OrderTicket{" + "orderId='" + orderId + '\'' + ", id=" + lineItemId + ", item="
                + item + ", name='" + name + '\'' + ", timestamp=" + timestamp + '}';
    }
